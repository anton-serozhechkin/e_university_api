from sqlalchemy import (
    MetaData, Column, Table, INTEGER, VARCHAR, FLOAT, ForeignKey, DATETIME, JSON, TIMESTAMP, DECIMAL
)
...
class UserRequestReview(Base):
    ...
    total_sum = Column(DECIMAL)  # TODO: change to DECIMAL and check
...
hostel_accommodation_view = Table('hostel_accommodation_view', metadata_obj,
                                  ...
                                  Column('room_number', INTEGER),
                                  Column('bed_place_name', VARCHAR(50)),
                                  Column('month_price', DECIMAL),  # TODO: change to DECIMAL and check
                                  Column('start_date_accommodation', TIMESTAMP),
                                  Column('end_date_accommodation', TIMESTAMP),
                                  Column('total_sum', DECIMAL),  # TODO: change to DECIMAL and check
