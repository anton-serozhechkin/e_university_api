...
class ServiceHandler:
    ...
    async def create_user_request_review(
        ...
        created_user_request_review = await user_request_review_service.create(
            ...
            data={
                ...
                "start_accommodation_date": user_request_review.start_accommodation_date.today(),
                "end_accommodation_date": user_request_review.end_accommodation_date.today(),
                "total_sum": user_request_review.total_sum,
                "payment_deadline_date": user_request_review.payment_deadline_date.today(),
    ...
    async def count_hostel_accommodation_cost(
        ...
        months_count = self.calculate_difference_between_dates_in_months(data.end_accommodation_date,
                                                                         data.start_accommodation_date)
    ...
    async def __create_user_document_content_hostel_settlement_service(cls, **kwargs) -> str:
        ...
        file_date_created = str(kwargs.get('created_at')).replace(":", "-").replace(" ", "_")
