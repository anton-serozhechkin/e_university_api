...
CREATE TABLE IF NOT EXISTS user_request_status(
    ...
    user_request_status_name varchar(50) NOT NULL,
    CONSTRAINT user_request_status_pk PRIMARY KEY (user_request_status_id));


INSERT INTO user_request_status(user_request_status_id, user_request_status_name) VALUES (1, 'Схвалено');
INSERT INTO user_request_status(user_request_status_id, user_request_status_name) VALUES (2, 'Відхилено');
INSERT INTO user_request_status(user_request_status_id, user_request_status_name) VALUES (3, 'Розглядається');
INSERT INTO user_request_status(user_request_status_id, user_request_status_name) VALUES (4, 'Скасовано');
...
FOREIGN KEY (user_request_status_id) REFERENCES user_request_status(user_request_status_id)
MATCH FULL ON DELETE SET NULL ON UPDATE CASCADE;
...
CREATE VIEW user_request_exist_view AS
    SELECT
        ...
        ur.university_id,
        ur.service_id,
        jsonb_build_object('user_request_status_id', ur.user_request_status_id, 'user_request_status_name', st.user_request_status_name) as user_request_status
    FROM
        user_request ur
    LEFT JOIN user_request_status st ON
        ur.user_request_status_id = st.user_request_status_id
    WHERE
