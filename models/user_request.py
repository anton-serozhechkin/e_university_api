...
class UserRequest(Base):
    ...
    user_request_status_id = Column(INTEGER, ForeignKey("user_request_status.id"))
    ...
    user_request_status = relationship("Status", back_populates="user_request")
    ...
    def __repr__(self):
        return f'{self.__class__.__name__}(user_request_id="{self.user_request_id}",' \
               ...
               f'faculty_id="{self.faculty_id}", university_id="{self.university_id}", user_request_status_id="{self.user_request_status_id}")'